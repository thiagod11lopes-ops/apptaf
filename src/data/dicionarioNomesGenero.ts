...
const MASCULINOS = [
  'aaron', 'abdiel', 'abel', 'abilio', 'abner', 'abraao', 'adailton', 'adaildo', 'adalberto', 'adalton', 'adam',
  'adeildo', 'adeilson', 'adelino', 'adelson', 'ademar', 'ademir', 'adenilson', 'adesio', 'adilson', 'adolfo',
  'adonis', 'adrian', 'adriano', 'aecio', 'afonso', 'agnaldo',

...
export function getUiColors(theme: AppTheme) {
  ...
  return {
    ...
    selectedBg: dark ? theme.primary : '#111827',
    unselectedBg: dark ? theme.backgroundSecondary : 'rgba(17,24,39,0.06)',
    ...
    btnPrimaryBg: dark ? theme.primary : '#374151',
    btnDarkBg: dark ? theme.primary : '#111827',
